            ...
            <c:if test="${problem.problemNumber == 3}">
                ...
                <div class="problem-section">
                    ...
                    <ul class="limit-list">
                        ...
                        <li>age\_type은 "Korea" 또는 "Year"만 주어집니다.</li>
            ...
            <c:if test="${problem.problemNumber == 6}">
                ...
                <div class="problem-section">
                    ...
                    <ul class="limit-list">
                        ...
                        <li>1 ≤ numbers의 길이 = our\_score의 길이 ≤ 10</li>

                        <li>1 ≤ numbers의 원소 ≤ 31</li>

                        <li>0 ≤ our\_score의 원소 ≤ 100</li>

                        <li>our\_score[i]는 numbers[i]번 학생이 가채점한 점수입니다.</li>

                        <li>numbers는 중복된 원소를 가지지 않습니다.</li>

                        <li>2 ≤ score\_list의 길이 ≤ 31</li>

                        <li>0 ≤ score\_list의 원소 ≤ 100</li>

                        <li>score\_list에는 실제 성적이 [1번 학생 성적, 2번 학생 성적, 3번 학생 성적 …] 순서로 들어있습니다.</li>
                    ...
                    <div class="saving-table-container">
                        ...
                        <table class="saving-table" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <th style="background-color: #202b3f; border: 1px solid #2b3548; padding: 8px 12px; font-weight: bold; color: #d1d1d1; text-align: left;">our\_score</th>

                                <th style="background-color: #202b3f; border: 1px solid #2b3548; padding: 8px 12px; font-weight: bold; color: #d1d1d1; text-align: left;">score\_list</th>
            ...
            <c:if test="${problem.problemNumber == 7}">
                ...
                <div class="problem-section">
                    ...
                    <ul class="limit-list">
                        ...
                        <li>mode\_type은 "auto", "target", "minimum" 세 가지 중 하나의 값을 갖습니다.</li>

                        <li>0 ≤ humidity, val\_set ≤ 100</li>
                    ...
                    <div class="saving-table-container">
                        ...
                        <table class="saving-table" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <th style="background-color: #202b3f; border: 1px solid #2b3548; padding: 8px 12px; font-weight: bold; color: #d1d1d1; text-align: left;">mode\_type</th>
                                ...
                                <th style="background-color: #202b3f; border: 1px solid #2b3548; padding: 8px 12px; font-weight: bold; color: #d1d1d1; text-align: left;">val\_set</th>
                ...
                <div class="problem-section">
                    ...
                    <div class="example-description">
                        ...
                        <ul class="description-list">
                            ...
                            <li>본문에 설명된 대로 창고를 정리하면 <code>clean\_storage = ["pencil", "book"]</code>, <code>clean\_num = [9, 1]</code>이 됩니다. 따라서 가장 개수가 많은 물건인 <code>"pencil"</code>을 return합니다.</li>
                    ...
                    <div class="example-description">
                        ...
                        <ul class="description-list">
                            ...
                            <li>창고를 정리하면 <code>clean\_storage = ["doll"]</code>, <code>clean\_num = [4]</code>가 됩니다. 따라서 가장 개수가 많은 물건인 <code>"doll"</code>을 return합니다.</li>
                    ...
                    <div class="example-description">
                        ...
                        <ul class="description-list">
                            ...
                            <li>창고를 정리하면 <code>clean\_storage = ["apple", "steel", "leaf"]</code>, <code>clean\_num = [8, 3, 12]</code>가 됩니다. 따라서 가장 개수가 많은 물건인 <code>"leaf"</code>를 return합니다.</li>
                    ...
                    <div class="example-description">
                        ...
                        <ul class="description-list">
                            ...
                            <li>창고를 정리하면 <code>clean\_storage = ["mirror", "net", "bottle"]</code>, <code>clean\_num = [8, 2, 5]</code>가 됩니다. 따라서 가장 개수가 많은 물건인 <code>"mirror"</code>를 return합니다.</li>
            ...
            <c:if test="${problem.problemNumber == 10}">
                ...
                <div class="problem-section">
                    ...
                    <ul class="limit-list">
                        ...
                        <li>ext와 sort\_by의 값은 다음 중 한 가지를 가집니다: <code>"code"</code>, <code>"date"</code>, <code>"maximum"</code>, <code>"remain"</code>
                        ...
                        <li>val\_ext는 ext에 따라 올바른 범위의 숫자로 주어집니다.</li>
                    ...
                    <div class="saving-table-container">
                        ...
                        <table class="saving-table" style="width: 100%; table-layout: fixed;">
                            ...
                            <tr>
                                ...
                                <th style="background-color: #202b3f; border: 1px solid #2b3548; padding: 8px 12px; font-weight: bold; color: #d1d1d1; text-align: left;">val\_ext</th>

                                <th style="background-color: #202b3f; border: 1px solid #2b3548; padding: 8px 12px; font-weight: bold; color: #d1d1d1; text-align: left;">sort\_by</th>
